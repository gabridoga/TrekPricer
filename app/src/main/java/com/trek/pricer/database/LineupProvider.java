...
public class LineupProvider extends ContentProvider {

	// All URIs share these parts
	public static final String AUTHORITY = "com.trek.pricer.provider";
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		if (URI_PERSONS.equals(uri)) {
			result = DatabaseHandler
					...
					.getReadableDatabase()
					.query(SavedLineup.TABLE_NAME, SavedLineup.FIELDS, null, null, null,
			...
			result = DatabaseHandler
					.getInstance(getContext())
					.getReadableDatabase()
					.query(SavedLineup.TABLE_NAME, SavedLineup.FIELDS,
							SavedLineup.COL_ID + " IS ?",
							new String[] { String.valueOf(id) }, null, null,
							SavedLineup.COL_TREKDATE + " DESC", null);
			result.setNotificationUri(getContext().getContentResolver(), URI_PERSONS);
		} else {
			throw new UnsupportedOperationException("Not yet implemented");
		}
