...
public class CarFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        distance = (TextView) parentView.findViewById(R.id.car_distance);
        duration = (TextView) parentView.findViewById(R.id.car_duration);
        avgSpeed = (TextView) parentView.findViewById(R.id.car_avg_speed);
        maxSpeed = (TextView) parentView.findViewById(R.id.car_max_speed);
        date = (TextView) parentView.findViewById(R.id.car_date);
        time = (TextClock) parentView.findViewById(R.id.car_time);
        savings = (TextView) parentView.findViewById(R.id.car_savings);
        todaySavings = (TextView) parentView.findViewById(R.id.car_today_savings);
        netSavings = (TextView) parentView.findViewById(R.id.car_net_saving);
        stopWatch = (Chronometer) parentView.findViewById(R.id.car_chrono);
        startTrek = (ButtonRectangle) parentView.findViewById(R.id.car_start_trek);
        pauseTrek = (ButtonRectangle) parentView.findViewById(R.id.car_pause_trek);
        resumeTrek = (ButtonRectangle) parentView.findViewById(R.id.car_resume_trek);
        saveTrek = (ButtonRectangle) parentView.findViewById(R.id.btn_car_save_trek);
        discardTrek = (ButtonRectangle) parentView.findViewById(R.id.btn_car_discard_trek);
        endTrek = (ButtonRectangle) parentView.findViewById(R.id.car_end_trek);
        bottomButtonBar = (LinearLayout) parentView.findViewById(R.id.car_bottom_button_bar);
        bottomButtonBar2 = (LinearLayout) parentView.findViewById(R.id.car_bottom_button_bar_2);
    ...
    private class AsyncTaskRunner extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                int updateFrequency =  Integer.parseInt(PreferenceManager.getDefaultSharedPreferences(getActivity()).getString("car_frequency", "10"));
                ...
                tracker = new LocationTracker(
                    ...
                    public void onLocationFound(Location location) {
                        ...
                        if (location.getAccuracy() <= 50 && isTrekOn) {
