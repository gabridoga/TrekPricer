...
public class SharedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        parentView = inflater.inflate(R.layout.fragment_shared, container, false);

        distance = (TextView) parentView.findViewById(R.id.shared_distance);
        duration = (TextView) parentView.findViewById(R.id.shared_duration);
        avgSpeed = (TextView) parentView.findViewById(R.id.shared_avg_speed);
        maxSpeed = (TextView) parentView.findViewById(R.id.shared_max_speed);
        date = (TextView) parentView.findViewById(R.id.shared_date);
        time = (TextClock) parentView.findViewById(R.id.shared_time);
        savings = (TextView) parentView.findViewById(R.id.shared_savings);
        todaySavings = (TextView) parentView.findViewById(R.id.shared_today_savings);
        netSavings = (TextView) parentView.findViewById(R.id.shared_net_saving);
        stopWatch = (Chronometer) parentView.findViewById(R.id.shared_chrono);
        startTrek = (ButtonRectangle) parentView.findViewById(R.id.shared_start_trek);
        pauseTrek = (ButtonRectangle) parentView.findViewById(R.id.shared_pause_trek);
        resumeTrek = (ButtonRectangle) parentView.findViewById(R.id.shared_resume_trek);
        saveTrek = (ButtonRectangle) parentView.findViewById(R.id.btn_shared_save_trek);
        discardTrek = (ButtonRectangle) parentView.findViewById(R.id.btn_shared_discard_trek);
        endTrek = (ButtonRectangle) parentView.findViewById(R.id.shared_end_trek);
        bottomButtonBar = (LinearLayout) parentView.findViewById(R.id.shared_bottom_button_bar);
        bottomButtonBar2 = (LinearLayout) parentView.findViewById(R.id.shared_bottom_button_bar_2);
    ...
    private class AsyncTaskRunner extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                int updateFrequency =  Integer.parseInt(PreferenceManager.getDefaultSharedPreferences(getActivity()).getString("shared_frequency", "10"));
                ...
                tracker = new LocationTracker(
                    ...
                    public void onLocationFound(Location location) {
                        ...
                        if (location.getAccuracy() <= 150 && isTrekOn) {
    ...
    public void setMaxSpeed(float speed) {
        ...
        if (speed > previousMaxSpeed) {
            DecimalFormat df = new DecimalFormat("#.##");
            maxSpeed.setText(String.valueOf(df.format(speed)));
