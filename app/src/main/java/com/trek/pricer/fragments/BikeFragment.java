...
public class BikeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        parentView = inflater.inflate(R.layout.fragment_bike, container, false);

        distance = (TextView) parentView.findViewById(R.id.bike_distance);
        duration = (TextView) parentView.findViewById(R.id.bike_duration);
        avgSpeed = (TextView) parentView.findViewById(R.id.bike_avg_speed);
        maxSpeed = (TextView) parentView.findViewById(R.id.bike_max_speed);
        date = (TextView) parentView.findViewById(R.id.bike_date);
        time = (TextClock) parentView.findViewById(R.id.bike_time);
        savings = (TextView) parentView.findViewById(R.id.bike_savings);
        todaySavings = (TextView) parentView.findViewById(R.id.bike_today_savings);
        netSavings = (TextView) parentView.findViewById(R.id.bike_net_saving);
        stopWatch = (Chronometer) parentView.findViewById(R.id.bike_chrono);
        startTrek = (ButtonRectangle) parentView.findViewById(R.id.bike_start_trek);
        pauseTrek = (ButtonRectangle) parentView.findViewById(R.id.bike_pause_trek);
        resumeTrek = (ButtonRectangle) parentView.findViewById(R.id.bike_resume_trek);
        saveTrek = (ButtonRectangle) parentView.findViewById(R.id.btn_bike_save_trek);
        discardTrek = (ButtonRectangle) parentView.findViewById(R.id.btn_bike_discard_trek);
        endTrek = (ButtonRectangle) parentView.findViewById(R.id.bike_end_trek);
        bottomButtonBar = (LinearLayout) parentView.findViewById(R.id.bike_bottom_button_bar);
        bottomButtonBar2 = (LinearLayout) parentView.findViewById(R.id.bike_bottom_button_bar_2);
    ...
    private class AsyncTaskRunner extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                int updateFrequency =  Integer.parseInt(PreferenceManager.getDefaultSharedPreferences(getActivity()).getString("bike_frequency", "10"));
                ...
                tracker = new LocationTracker(
                    ...
                    public void onLocationFound(Location location) {
                        ...
                        if (location.getAccuracy() <= 100 && isTrekOn) {
